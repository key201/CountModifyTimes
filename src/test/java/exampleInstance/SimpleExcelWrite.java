...
import exampleInstance.SAXOperateXmlDemo.LogInfomation;
import jxl.CellType;
import jxl.Workbook;
...
public class SimpleExcelWrite {
	...
	public static int computeModifCount(String cmdExe) throws SVNException, IOException, RowsExceededException, WriteException{
	...
	public static void main(String arge[]) throws  IOException,  WriteException{
...
//		initExcel() ;		
		...
		String cloneDetectPath = FileNameManage.getCloneDetectPath();
		String cmdExe  = null;
